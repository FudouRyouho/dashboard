...
export const sonarrCalendarEventSchema = z.object({ id: z.number(), title: z.string(), airDateUtc: z.coerce.date(), seasonNumber: z.number(), episodeNumber: z.number(), images: z.array(sonarrImageSchema).default([]) , series: sonarrSeriesSchema }).passthrough();
